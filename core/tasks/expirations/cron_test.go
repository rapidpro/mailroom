...
func TestExpirations(t *testing.T) {
	...
	s1 := testdata.InsertFlowSession(t, db, flows.SessionUUID(uuids.New()), testdata.Org1.ID, models.CathyID, models.SessionStatusWaiting, nil)
	s2 := testdata.InsertFlowSession(t, db, flows.SessionUUID(uuids.New()), testdata.Org1.ID, models.GeorgeID, models.SessionStatusWaiting, nil)
	s3 := testdata.InsertFlowSession(t, db, flows.SessionUUID(uuids.New()), testdata.Org1.ID, models.BobID, models.SessionStatusWaiting, nil)

	// simple run, no parent
	r1ExpiresOn := time.Now()
	testdata.InsertFlowRun(t, db, "f240ab19-ed5d-4b51-b934-f2fbb9f8e5ad", testdata.Org1.ID, s1, models.CathyID, models.FavoritesFlowID, models.RunStatusWaiting, "", &r1ExpiresOn)

	// parent run
	r2ExpiresOn := time.Now().Add(time.Hour * 24)
	testdata.InsertFlowRun(t, db, "c4126b59-7a61-4ed5-a2da-c7857580355b", testdata.Org1.ID, s2, models.GeorgeID, models.FavoritesFlowID, models.RunStatusWaiting, "", &r2ExpiresOn)

	// child run
	r3ExpiresOn := time.Now()
	testdata.InsertFlowRun(t, db, "a87b7079-5a3c-4e5f-8a6a-62084807c522", testdata.Org1.ID, s2, models.GeorgeID, models.FavoritesFlowID, models.RunStatusWaiting, "c4126b59-7a61-4ed5-a2da-c7857580355b", &r3ExpiresOn)

	// run with no session
	r4ExpiresOn := time.Now()
	testdata.InsertFlowRun(t, db, "d64fac33-933f-44b4-a6e4-53283d07a609", testdata.Org1.ID, models.SessionID(0), models.CathyID, models.FavoritesFlowID, models.RunStatusWaiting, "", &r4ExpiresOn)

	// run with no expires_on
	testdata.InsertFlowRun(t, db, "4391fdc4-25ca-4e66-8e05-0cd3a6cbb6a2", testdata.Org1.ID, s3, models.BobID, models.FavoritesFlowID, models.RunStatusWaiting, "", nil)
