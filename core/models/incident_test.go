...
func TestIncidentWebhooksUnhealthy(t *testing.T) {
	...
	assertredis.StringSet(t, rp, fmt.Sprintf("incident:%d:nodes", id1), []string{"5a2e83f1-efa8-40ba-bc0c-8873c525de7d", "aba89043-6f0a-4ccf-ba7f-0e1674b90759"})
	...
	testsuite.AssertQuery(t, db, `SELECT count(*) FROM notifications_incident`).Returns(1)
	assertredis.StringSet(t, rp, fmt.Sprintf("incident:%d:nodes", id1), []string{"3b1743cd-bd8b-449e-8e8a-11a3bc479766", "5a2e83f1-efa8-40ba-bc0c-8873c525de7d", "aba89043-6f0a-4ccf-ba7f-0e1674b90759"})
