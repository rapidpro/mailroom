...
func NotifyImportFinished(ctx context.Context, db DBorTxx, imp *ContactImport) error {
	n := &Notification{
		OrgID:           imp.OrgID,
...
func NotifyIncidentStarted(ctx context.Context, db DBorTxx, oa *OrgAssets, incident *Incident) error {
...
func NotificationsFromTicketEvents(ctx context.Context, db DBorTxx, oa *OrgAssets, events map[*Ticket]*TicketEvent) error {
...
func insertNotifications(ctx context.Context, db DBorTxx, notifications []*Notification) error {
