...
func NewClassifierCalledLog(orgID OrgID, cid ClassifierID, url string, request string, response string, isError bool, elapsedMS int, createdOn time.Time) *HTTPLog {
	h := &HTTPLog{}
