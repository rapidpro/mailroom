...
func TestTicketClose(t *testing.T) {
	...
	testdata.InsertOpenTicket(t, db, models.Org1, models.CathyID, models.ZendeskID, flows.TicketUUID(uuids.New()), "Need help", "Have you seen my cookies?", "17")
...
func TestTicketReopen(t *testing.T) {
	...
	testdata.InsertClosedTicket(t, db, models.Org1, models.CathyID, models.ZendeskID, flows.TicketUUID(uuids.New()), "Need help", "Have you seen my cookies?", "17")
