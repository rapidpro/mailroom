...
func InsertIncomingMsg(t *testing.T, db *sqlx.DB, org *Org, contactID models.ContactID, urn urns.URN, urnID models.URNID, text string) *flows.MsgIn {
...
func InsertOutgoingMsg(t *testing.T, db *sqlx.DB, org *Org, contactID models.ContactID, urn urns.URN, urnID models.URNID, text string, attachments []utils.Attachment) *flows.MsgOut {
