...
func TestIVR(t *testing.T) {
	...
	start := models.NewFlowStart(models.NilStartID, models.Org1, models.IVRFlow, models.IVRFlowID, nil, []models.ContactID{models.CathyID}, nil, false, true, true, nil, nil)
