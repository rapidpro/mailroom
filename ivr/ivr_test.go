...
func TestIVR(t *testing.T) {
	...
	start := models.NewFlowStart(models.NilStartID, models.Org1, models.IVRFlow, models.IVRFlowID, nil, []flows.ContactID{models.CathyID}, nil, false, true, true, nil, nil)
