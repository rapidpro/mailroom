...
func (l *Locker) Grab(rc redis.Conn, retry time.Duration) (string, error) {
...
func (l *Locker) Release(rc redis.Conn, value string) error {
...
func (l *Locker) Extend(rc redis.Conn, value string, expiration time.Duration) error {
