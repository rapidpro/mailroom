...
func TestSendMessage(t *testing.T) {
	...
	_, _, err := client.SendMessage("Bob <ticket+12446@tickets.rapidpro.io>", "support@acme.com", "Need help", "Where are my cookies?", "12415")
	...
	msgID, trace, err := client.SendMessage("Bob <ticket+12446@tickets.rapidpro.io>", "support@acme.com", "Need help", "Where are my cookies?", "12415")
